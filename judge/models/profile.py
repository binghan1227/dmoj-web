...
from judge.models.choices import MATH_ENGINES_CHOICES
from judge.models.choices import SITE_THEMES
...
class Profile(models.Model):
    ...
    scratch_codes = EncryptedNullCharField(
        ...
        help_text=_('JSON array of 16-character Base32-encoded codes for scratch codes.'),
        validators=[
            RegexValidator(
