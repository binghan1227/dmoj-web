        ...
        if not linked:
            for model_name in ('OrganizationMember', 'OrganizationMembership', 'OrganizationUser'):
                ...
                if MemberModel:
                    ...
                    org_field = (
                        'organization'
                        if 'organization' in possible_org_fields
                        else ('org' if 'org' in possible_org_fields else None)
                    )
                    user_field = (
                        'user'
                        if 'user' in possible_org_fields
                        else ('profile' if 'profile' in possible_org_fields else None)
                    )
