...
from django_social_share.templatetags.social_share import post_to_facebook_url
from django_social_share.templatetags.social_share import post_to_twitter_url
