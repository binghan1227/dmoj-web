...
from judge.feed import AtomBlogFeed
from judge.feed import AtomCommentFeed
from judge.feed import AtomProblemFeed
from judge.feed import BlogFeed
from judge.feed import CommentFeed
from judge.feed import ProblemFeed
from judge.sitemap import sitemaps
from judge.views import api
from judge.views import blog
from judge.views import comment
from judge.views import contests
from judge.views import ide
from judge.views import language
from judge.views import license
from judge.views import mailgun
from judge.views import organization
from judge.views import preview
from judge.views import problem
from judge.views import problem_manage
from judge.views import ranked_submission
from judge.views import register
from judge.views import stats
from judge.views import status
from judge.views import submission
from judge.views import tasks
from judge.views import ticket
from judge.views import TitledTemplateView
from judge.views import two_factor
from judge.views import user
from judge.views import widgets
from judge.views.problem_data import download_test_case
from judge.views.problem_data import download_tester
from judge.views.problem_data import problem_data_file
from judge.views.problem_data import problem_init_view
from judge.views.problem_data import ProblemDataView
from judge.views.problem_data import ProblemSubmissionDiff
from judge.views.register import ActivationView
from judge.views.register import RegistrationView
from judge.views.select2 import AssigneeSelect2View
from judge.views.select2 import ClassSelect2View
from judge.views.select2 import CommentSelect2View
from judge.views.select2 import ContestSelect2View
from judge.views.select2 import ContestUserSearchSelect2View
from judge.views.select2 import OrganizationSelect2View
from judge.views.select2 import ProblemSelect2View
from judge.views.select2 import TicketUserSelect2View
from judge.views.select2 import UserSearchSelect2View
...
register_patterns = [
    ...
    path(
        'email/change/activate/<str:activation_key>/',
